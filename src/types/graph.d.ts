...
export interface GetNearbyDriversResopnse {
  ok: boolean;
  error: string | null;
...
export interface AddPlaceResposne {
  ok: boolean;
  error: string | null;
}
